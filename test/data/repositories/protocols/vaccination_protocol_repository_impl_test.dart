// File: test/data/repositories/protocols/vaccination_protocol_repository_impl_test.dart
...
// NOTE: These tests verify repository logic by directly testing Hive box operations
// since VaccinationProtocolRepositoryImpl depends on HiveManager singleton which requires
// full app initialization with encryption services.
...
void main() {
  group('VaccinationProtocolRepository (Hive Integration)', () {
    late Box<VaccinationProtocol> box;
    late VaccinationProtocolRepositoryImpl repository;

    setUpAll(() async {
      // Initialize Hive for testing
      Hive.init('test_hive_db_vaccination_protocol_repo');
    ...
    setUp(() async {
      ...
      // Using the same box name that VaccinationProtocolRepositoryImpl uses via HiveManager
      box = await Hive.openBox<VaccinationProtocol>('vaccination_protocols');
      await box.clear();

      // Create repository instance with the test box
      repository = VaccinationProtocolRepositoryImpl(box: box);
    });

    tearDown(() async {
      // Clean up after each test
      await box.close();
      await Hive.deleteBoxFromDisk('vaccination_protocols');
    });
    ...
    VaccinationProtocol createTestProtocol({
      ...
      return VaccinationProtocol(
        ...
        description: 'Test protocol for $species',
        isCustom: isCustom,
        region: 'Romania/EU',
        createdAt: createdAt,
      );
    ...
    group('save', () {
      test('should save vaccination protocol to Hive box', () async {
        // Arrange
    ...
    group('getById', () {
      test('should retrieve vaccination protocol by ID when it exists', () async {
        // Arrange
        final protocol = createTestProtocol(
          id: 'test_protocol_1',
          name: 'Test Protocol',
    ...
    group('getAll', () {
      ...
      test('should return all vaccination protocols', () async {
        // Arrange
        final protocol1 = createTestProtocol(
          id: 'protocol_1',
          name: 'Protocol 1',
    ...
    group('delete', () {
      test('should delete vaccination protocol by ID when it exists', () async {
        // Arrange
        final protocol = createTestProtocol(
          id: 'test_protocol_1',
          name: 'Test Protocol',
    ...
    group('deleteAll', () {
      test('should delete all vaccination protocols from box', () async {
        // Arrange
        final protocol1 = createTestProtocol(
          id: 'protocol_1',
          name: 'Protocol 1',
