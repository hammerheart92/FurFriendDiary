...
/// Protocol Selection Screen - Allows users to select a vaccination protocol for their pet
///
/// This screen displays available vaccination protocols filtered by the pet's species
/// and allows the user to select one to apply to their pet.
///
/// Navigation: Expects a `PetProfile` object as argument
/// Returns: bool (true if protocol was applied successfully)
class ProtocolSelectionScreen extends ConsumerWidget {
  ...
  Future<void> _applyProtocol(
    ...
    try {
      _logger.d('Applying protocol ${protocol.id} to pet ${pet.id}');
...
class _ProtocolCard extends StatelessWidget {
  ...
  /// Determine if protocol is core by checking if name contains "Core"
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Metadata (vaccine count and region)
                      Row(
                        children: [
                          Icon(
                            Icons.vaccines,
